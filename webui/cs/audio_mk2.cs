<?cs def:audio_mk2_cfg1(unit, chan, keyer_type) ?>
...
<?cs def:audio_mk2_cfg(unit, chan) ?>

<?cs call:audio_mk2_cfg1(unit, chan, mhuxd.run.keyer[mhuxd.webui.session.unit].info.type) ?>
