...
<?cs def:audio_mk2r_r1_cfg1(unit, chan, keyer_type) ?>

<?cs call:sectionheader("Audio Switching Radio 1", "foobar_help") ?>
&nbsp;&nbsp;<br>
...
<table class="sectiontable" cellpadding="3" cellspacing="0" width="100%">
  <tbody>
	...
	<?cs call:opt_bool_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Cw.audioRxMic", 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Cw.audioRxMic ) 
	     ?>
      </td>
      <td class="contentlistcell">
	<?cs call:opt_select_basic(
      ...
      <td width="5%" class="contentlistcell">
	<?cs call:opt_bool_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Cw.audioTxMic", 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Cw.audioTxMic) 
	     ?>
      </td>
      <td class="contentlistcell">
	<?cs call:opt_select_basic(
      ...
      <td width="5%" class="contentlistcell">
	<?cs call:opt_bool_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Cw.audioTxFootSwMic", 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Cw.audioTxFootSwMic ) 
	     ?>
      </td>
      <td class="contentlistcell">
	<?cs call:opt_select_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Cw.voiceCodec", 
	     mhuxd.webui.options.mk2r_codecs, 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Cw.voiceCodec ) 
	     ?>
      </td>
    </tr>
	...
	<?cs call:opt_select_basic(
      ...
      <td width="5%" class="contentlistcell">
	<?cs call:opt_bool_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Voice.audioRxMic", 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Voice.audioRxMic ) 
	     ?>
      </td>
      <td class="contentlistcell">
	<?cs call:opt_select_basic(
      ...
      <td width="5%" class="contentlistcell">
	<?cs call:opt_bool_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Voice.audioTxMic", 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Voice.audioTxMic ) 
	     ?>
      </td>
      <td class="contentlistcell">
	<?cs call:opt_select_basic(
      ...
      <td width="5%" class="contentlistcell">
	<?cs call:opt_bool_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Voice.audioTxFootSwMic", 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Voice.audioTxFootSwMic ) 
	     ?>
      </td>
      <td class="contentlistcell">
	<?cs call:opt_select_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Voice.voiceCodec", 
	     mhuxd.webui.options.mk2r_codecs, 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Voice.voiceCodec ) 
	     ?>
      </td>
    </tr>
	...
	<?cs call:opt_select_basic(
      ...
      <td width="5%" class="contentlistcell">
	<?cs call:opt_bool_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Digital.audioRxMic", 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Digital.audioRxMic ) 
	     ?>
      </td>
      <td class="contentlistcell">
	<?cs call:opt_select_basic(
	...
	<?cs call:opt_bool_basic(
      ...
      <td class="contentlistcell">
	<?cs call:opt_select_basic(
	     "set.mhuxd.keyer."+unit+".param.r1FrMokExtra_Digital.voiceCodec", 
	     mhuxd.webui.options.mk2r_codecs, 
	     mhuxd.keyer[unit].param.r1FrMokExtra_Digital.voiceCodec ) 
	     ?>
      </td>
    </tr>
...
<?cs def:audio_mk2r_r1_cfg(unit, chan) ?>

<?cs call:audio_mk2r_r1_cfg1(unit, chan, mhuxd.run.keyer[mhuxd.webui.session.unit].info.type) ?>
