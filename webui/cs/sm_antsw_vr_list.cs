  ...
  <tbody>
	...
	<input type="checkbox" name="modify.mhuxd.keyer.<?cs var:unit ?>.sm.obj.<?cs var:name(item) ?>.ref.<?cs var:name(ref_item) ?>" value="1" > 
      ...
      <td class="contentlistcell" align="center"><?cs call:opt_number_basic(
				       "modify.mhuxd.keyer."+unit+".sm.obj."+name(item)+".ref."+name(ref_item)+".min_azimuth", 
				       mhuxd.keyer[unit].sm.obj[name(item)].ref[name(ref_item)].min_azimuth) ?> </td>

      <td class="contentlistcell" align="center"><?cs call:opt_number_basic(
				       "modify.mhuxd.keyer."+unit+".sm.obj."+name(item)+".ref."+name(ref_item)+".max_azimuth", 
				       mhuxd.keyer[unit].sm.obj[name(item)].ref[name(ref_item)].max_azimuth) ?> </td>
	...
	<?cs call:number_rw("modify.mhuxd.keyer."+unit+".sm.obj."+name(item)+".ref.0.min_azimuth", "") ?>
      ...
      <td class="contentlistcell" width="20%">
	<?cs call:number_rw("modify.mhuxd.keyer."+unit+".sm.obj."+name(item)+".ref.0.max_azimuth", "") ?>
      </td>
      <td class="contentlistcell" width="30%">
	<?cs call:select(
