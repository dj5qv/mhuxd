...
const struct mh_info_map mh_info_map[] = {
	...
	{ .type = MHT_CK,       
	  .name = "CW KEYER",
	  .flags = MHF_MHUXD_SUPPORTED|MHF_HAS_WINKEY },
	...
	{ .type = MHT_MK,      
	  ...
	  .flags = MHF_MHUXD_SUPPORTED|MHF_HAS_R1|MHF_HAS_WINKEY|MHF_HAS_FRBASE|MHF_HAS_FSK1|
		MHF_HAS_LNA_PA_PTT|MHF_HAS_AUDIO_SWITCHING },

	{ .type = MHT_MK2,     
	  .name = "micro KEYER II",
	  .flags = MHF_MHUXD_SUPPORTED|MHF_HAS_R1|MHF_HAS_R1_RADIO_SUPPORT|MHF_HAS_AUX|MHF_HAS_WINKEY|MHF_HAS_FRBASE_VOICE|
