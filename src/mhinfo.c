...
const struct mh_info_map mh_info_map[] = {
	...
	{ .type = MHT_MK2,     
	  ...
	  .flags = MHF_MHUXD_SUPPORTED|MHF_HAS_R1|MHF_HAS_R1_RADIO_SUPPORT|MHF_HAS_AUX|
		...
		MHF_HAS_KEYER_MODE|MHF_HAS_FLAGS_CHANNEL|MHF_HAS_MCP_SUPPORT|MHF_HAS_CAT_CMD},
	...
	{ .type = MHT_MK3,
	  ...
	  .flags = MHF_MHUXD_SUPPORTED|MHF_HAS_R1|MHF_HAS_R1_RADIO_SUPPORT|MHF_HAS_AUX|
		...
		MHF_HAS_LNA_PA_PTT_TAIL|MHF_HAS_SOUNDCARD_PTT|MHF_HAS_CW_IN_VOICE|MHF_HAS_AUDIO_SWITCHING|
		MHF_HAS_DISPLAY|MHF_HAS_FOLLOW_TX_MODE|MHF_HAS_PTT_SETTINGS|
		MHF_HAS_KEYER_MODE|MHF_HAS_FLAGS_CHANNEL|MHF_HAS_MCP_SUPPORT|MHF_HAS_PFSK|MHF_HAS_PCW|MHF_HAS_CAT_CMD},
	...
	{ .type = MHT_MK2Rp,   
	  ...
	  .flags = MHF_MHUXD_SUPPORTED|MHF_HAS_R1|MHF_HAS_R1_RADIO_SUPPORT|MHF_HAS_R2|
		...
		MHF_HAS_FLAGS_CHANNEL|MHF_HAS_MCP_SUPPORT|MHF_HAS_CAT_CMD},

	{ .type = MHT_SM,      
	  .name = "Station Master",
	  .flags = MHF_MHUXD_SUPPORTED|MHF_HAS_R1|MHF_HAS_R1_RADIO_SUPPORT|MHF_HAS_AUX|
	  MHF_HAS_DISPLAY|MHF_HAS_ROTATOR_SUPPORT|MHF_HAS_SM_COMMANDS|MHF_HAS_CAT_CMD },
